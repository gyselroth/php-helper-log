...
When contributing to gyselroth/php-helper-log, please first discuss the change you wish to make via an issue
within the [github repository](#https://github.com/gyselroth/php-helper-log/issues), before making a change. 
